...
type
  ...
  TFileAPI = class
  public
    procedure SaveToFile(fileName: string; bmp: bmpArray); virtual; abstract;
    function LoadFromFile(fileName: string): bmpArray; virtual; abstract;
  end;
  ...
  public
    ...
    procedure Save(bmp: bmpArray); virtual; abstract;
    function Load(): bmpArray; virtual; abstract;
  end;
  ...
  public
    ...
    procedure Save(bmp: bmpArray); override;
    function Load(): bmpArray; override;
  end;

  { Bridge Concrete Implementor for Bitmap Format }
  TBmpFileAPI = class(TFileAPI)
  public
    procedure SaveToFile(fileName: string; bmp: bmpArray); override;
...
function TBmpFileAPI.LoadFromFile(filename: string): bmpArray;
...
procedure TBmpFileAPI.SaveToFile(filename: string; bmp: bmpArray);
var
  outFile: file;
  header: array[0..53] of byte;
  pixelSize: integer;
